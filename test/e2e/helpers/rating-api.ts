...
export async function startQuote(
  ...
  const response = await request.post(`${config.apis.ratingandunderwriting}/api/risk-quotes/start`, {
    data,
...
export async function submitUnderwriting(
  ...
  const response = await request.post(
    `${config.apis.ratingandunderwriting}/api/risk-quotes/${quoteId}/submit-underwriting`,
    {
      data,
      timeout: config.timeouts.apiRequest,
    }
...
export async function acceptQuote(
  ...
  const response = await request.post(
    `${config.apis.ratingandunderwriting}/api/risk-quotes/${quoteId}/accept`,
    { timeout: config.timeouts.apiRequest }
  );
...
export async function getQuote(
  ...
  const response = await request.get(
    `${config.apis.ratingandunderwriting}/api/risk-quotes/${quoteId}`,
    { timeout: config.timeouts.apiRequest }
  );
