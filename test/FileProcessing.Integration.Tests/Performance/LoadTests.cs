...
/// Target: Support 1000+ FileProcessingConfigurations without performance degradation.
/// </summary>
public class LoadTests
{
    ...
    {
        // Arrange
        var mockRepo = new Mock<IFileProcessingConfigurationRepository>();
    ...
    private static FileProcessingConfiguration CreateTestConfigurationWithProtocol(
