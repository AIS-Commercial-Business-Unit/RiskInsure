...
- Constitution compliance checklist (12 principles)
...
- Do not leave placeholders like `services/<domain>/`, `[###-feature-name]`, `/docs/specs/###-...`, or token markers unresolved.
...
2. Data Model Strategy (Cosmos OR PostgreSQL)
...
9. Saga Workflow Orchestration
10. Test Coverage Requirements (Domain 90%+, Application 80%+)
11. Technology Constraints (.NET 10, NServiceBus 9.x)
