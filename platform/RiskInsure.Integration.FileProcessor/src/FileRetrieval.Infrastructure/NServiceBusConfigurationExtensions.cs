...
public static class NServiceBusConfigurationExtensions
{
        ...
        EndpointConfiguration endpointConfiguration)
    {
        ...
        {
            throw new InvalidOperationException(
                "RabbitMQ connection string missing. Add ConnectionStrings:RabbitMQ to configuration");
        }
        ...
        this EndpointConfiguration endpointConfiguration)
    {
        ...
        conventions.DefiningEventsAs(type =>
            type.Namespace != null && type.Namespace.Contains(".Events"));
        conventions.DefiningCommandsAs(type =>
            type.Namespace != null && type.Namespace.Contains(".Commands"));
