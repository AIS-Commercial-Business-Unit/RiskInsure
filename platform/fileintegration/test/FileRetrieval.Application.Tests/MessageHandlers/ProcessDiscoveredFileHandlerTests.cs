...
using Moq;
using NServiceBus;
using RiskInsure.FileRetrieval.Application.MessageHandlers;
...
namespace FileRetrieval.Application.Tests.MessageHandlers;
...
public class ProcessDiscoveredFileHandlerTests
{
    ...
    public async Task Handle_WithNachaProcessingConfig_PublishesRowEventsAndSendsRowCommands()
    {
        ...
        var configurationRepository = new Mock<IFileRetrievalConfigurationRepository>();
        ...
        httpClientFactory
            .Setup(x => x.CreateClient("FileRetrievalHttpsDownload"))
    ...
    private static FileRetrievalConfiguration CreateConfiguration(string fileType)
    {
