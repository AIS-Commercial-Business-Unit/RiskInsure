...
**File**: `src/FileRetrieval.Application/Services/DiscoveredFileContentDownloadService.cs`
...
**Files**:
- ✅ `src/FileRetrieval.Application/Protocols/FtpProtocolAdapter.cs` (lines 14-18, 245-270)
- ✅ `src/FileRetrieval.Application/Protocols/HttpsProtocolAdapter.cs` (lines 21-22, 271-305)
