...
namespace RiskInsure.FileProcessing.Infrastructure.Scheduling;
...
public class SchedulerHostedService : BackgroundService
{
    ...
    private async Task CheckScheduledConfigurationsAsync(CancellationToken cancellationToken)
    {
        ...
        _logger.LogDebug("Checking for scheduled file processing configurations at {CheckTime}", checkTime);
        ...
        try
        {
            ...
            var configurationRepository = scope.ServiceProvider.GetRequiredService<IFileProcessingConfigurationRepository>();
