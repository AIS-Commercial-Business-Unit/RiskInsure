...
/// <summary>
/// Handles CreateConfiguration commands to create new file processing configurations.
/// </summary>
public class CreateConfigurationHandler : IHandleMessages<CreateConfiguration>
{
    ...
    private FileProcessingConfiguration MapCommandToEntity(CreateConfiguration message)
    {
        // Parse protocol type
