...
/// <summary>
/// T102: Service for collecting and exposing metrics about file processing operations.
/// Tracks active configurations per client, execution counts per protocol, and other operational metrics.
/// </summary>
public class FileProcessingMetricsService
{
    private readonly ILogger<FileProcessingMetricsService> _logger;
    ...
    {
        _logger = logger;
        _meter = new Meter("RiskInsure.FileProcessing", "1.0.0");
        ...
        _configurationsCreatedCounter = _meter.CreateCounter<long>(
            "file_processing_configurations_created_total",
        ...
        _meter.CreateObservableGauge(
            "file_processing_active_configurations_by_client",
        ...
        _meter.CreateObservableGauge(
            "file_processing_executions_by_protocol",
        ...
        _meter.CreateObservableGauge(
            "file_processing_failures_by_protocol",
