...
/// <summary>
/// Service for managing FileProcessingConfiguration entities.
/// Provides business logic layer between message handlers/controllers and repositories.
/// </summary>
public class ConfigurationService
{
    private readonly IFileProcessingConfigurationRepository _repository;
    private readonly ILogger<ConfigurationService> _logger;

    public ConfigurationService(
        IFileProcessingConfigurationRepository repository,
    ...
    /// <summary>
    /// Creates a new FileProcessingConfiguration.
    /// </summary>
