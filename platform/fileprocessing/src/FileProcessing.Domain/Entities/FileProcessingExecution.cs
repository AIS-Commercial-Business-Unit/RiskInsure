...
/// <summary>
/// Represents a single execution attempt of a FileProcessingConfiguration, 
/// tracking success/failure and discovered files.
/// </summary>
public class FileProcessingExecution
{
    /// <summary>
    ...
    /// </summary>
    public string Type { get; set; } = nameof(FileProcessingExecution);
