# File Processing Domain Standards

**T133 - Principle I**: Domain Language Consistency

This document defines the domain terminology, coding standards, and architectural patterns for the File Processing bounded context within the RiskInsure platform.
...
**Entities**
- PascalCase: `FileProcessingConfiguration`, `FileProcessingExecution`, `DiscoveredFile`
...
**Repositories**
- Interface: `I{EntityName}Repository` → `IFileProcessingConfigurationRepository`
- Implementation: `{EntityName}Repository` → `FileProcessingConfigurationRepository`
...
public FileProcessingConfiguration Create(FileProcessingConfiguration configuration)
{
...
### Metrics Collection
- Custom metrics via `FileProcessingMetricsService`
...
- **Contracts**: `/specs/001-file-processing-config/contracts/`
- **Deployment**: `/services/file-processing/docs/deployment.md`
- **Monitoring**: `/services/file-processing/docs/monitoring.md`
- **Runbook**: `/services/file-processing/docs/runbook.md`
