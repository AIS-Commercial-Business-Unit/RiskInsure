...
This document describes the protocol-specific settings for file processing configurations. Each protocol type requires different connection parameters passed through the `protocolSettings` field as a dictionary of key-value pairs.
