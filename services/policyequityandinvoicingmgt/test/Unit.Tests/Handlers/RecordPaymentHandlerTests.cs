namespace RiskInsure.PolicyEquityAndInvoicingMgt.Unit.Tests.Handlers;
...
using RiskInsure.PolicyEquityAndInvoicingMgt.Endpoint.In.Handlers;
...
{
    private readonly Mock<IPolicyEquityAndInvoicingPaymentManager> _mockManager;
    ...
    {
        _mockManager = new Mock<IPolicyEquityAndInvoicingPaymentManager>();
    ...
    public async Task Handle_SuccessfulPayment_ProcessesWithoutError()
    {
        ...
        var updatedAccount = new PolicyEquityAndInvoicingAccount
        {
            AccountId = "test-account",
            CustomerId = "CUST-123",
