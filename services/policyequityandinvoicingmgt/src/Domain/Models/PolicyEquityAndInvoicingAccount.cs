namespace RiskInsure.PolicyEquityAndInvoicingMgt.Domain.Models;
...
public class PolicyEquityAndInvoicingAccount
{
    ...
    /// </summary>
    public PolicyEquityAndInvoicingAccountStatus Status { get; set; }
    
    /// <summary>
    /// Billing cycle for the policy
    /// </summary>
    public PolicyEquityAndInvoicingCycle PolicyEquityAndInvoicingCycle { get; set; }
...
/// </summary>
public enum PolicyEquityAndInvoicingAccountStatus
{
    /// <summary>
...
/// </summary>
public enum PolicyEquityAndInvoicingCycle
{
    /// <summary>
