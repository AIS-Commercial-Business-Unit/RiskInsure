...
public class PaymentRecordingResult
{
    ...
    /// </summary>
    public PolicyEquityAndInvoicingAccount? UpdatedAccount { get; set; }
    ...
    /// </summary>
    public static PaymentRecordingResult Success(PolicyEquityAndInvoicingAccount account, bool wasDuplicate = false)
    {
