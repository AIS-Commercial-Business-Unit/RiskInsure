...
namespace RiskInsure.PolicyEquityAndInvoicingMgt.Endpoint.In.Handlers;

/// <summary>
/// Handles RecordPayment commands by delegating to the PolicyEquityAndInvoicingPaymentManager.
...
{
    private readonly IPolicyEquityAndInvoicingPaymentManager _manager;
    private readonly ILogger<RecordPaymentHandler> _logger;

    public RecordPaymentHandler(
        IPolicyEquityAndInvoicingPaymentManager manager,
