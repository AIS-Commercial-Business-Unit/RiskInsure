...
/// <summary>
/// API controller for policy equity and invoicing payment operations.
/// Supports both synchronous (direct manager call) and asynchronous (command publishing) patterns.
/// </summary>
[ApiController]
[Route("api/policyequityandinvoicingmgt/payments")]
[Produces("application/json")]
public class PolicyEquityAndInvoicingPaymentsController : ControllerBase
{
    private readonly IPolicyEquityAndInvoicingPaymentManager _paymentManager;
    private readonly IMessageSession _messageSession;
    private readonly ILogger<PolicyEquityAndInvoicingPaymentsController> _logger;

    public PolicyEquityAndInvoicingPaymentsController(
        IPolicyEquityAndInvoicingPaymentManager paymentManager,
        IMessageSession messageSession,
        ILogger<PolicyEquityAndInvoicingPaymentsController> logger)
    {
    ...
    /// <summary>
    /// Records a payment to a policy equity and invoicing account synchronously.
    ...
    /// <response code="404">Policy equity and invoicing account not found</response>
    [HttpPost]
    ...
    /// <summary>
    /// Records a payment to a policy equity and invoicing account asynchronously.
    ...
    {
        return Ok(new { Status = "Healthy", Service = "PolicyEquityAndInvoicing Payments API" });
    }
}
