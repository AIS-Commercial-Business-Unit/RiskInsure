...
using RiskInsure.PolicyEquityAndInvoicingMgt.Domain.Services.BillingDb;
        ...
        options.AddDocumentTransformer((document, context, cancellationToken) =>
        {
            document.Info = new()
            {
                ...
                Description = """
                    ...
                    ### Policy Equity and Invoicing Accounts (`/api/policyequityandinvoicingmgt/accounts`)
                    ...
                    ### Policy Equity and Invoicing Payments (`/api/policyequityandinvoicingmgt/payments`)
