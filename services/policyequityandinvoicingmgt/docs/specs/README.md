# PolicyEquityAndInvoicing Domain - Feature Specifications

This index lists all feature specifications that affect the **PolicyEquityAndInvoicing** bounded context.

**Feature specs live in**: `/specs/###-feature-name/` (repo root)  
**This index provides**: Domain-specific view of features for PolicyEquityAndInvoicing

---

## Documentation Philosophy

- **Domain docs** (`services/PolicyEquityAndInvoicing/docs/`) = **Current state** (living documentation of how PolicyEquityAndInvoicing works today)
...
*Features currently being developed that affect PolicyEquityAndInvoicing*
...
<!-- Example:
- [003-multi-policy-PolicyEquityAndInvoicing](/specs/003-multi-policy-PolicyEquityAndInvoicing/spec.md) - Consolidated PolicyEquityAndInvoicing for multiple policies (Shipped: 2026-02-01)
-->
...
*Complete chronological list of all features that touched PolicyEquityAndInvoicing domain*
...
/speckit.specify [your feature description affecting PolicyEquityAndInvoicing]
...
- [Overview](../overview.md) - PolicyEquityAndInvoicing domain purpose and responsibilities
