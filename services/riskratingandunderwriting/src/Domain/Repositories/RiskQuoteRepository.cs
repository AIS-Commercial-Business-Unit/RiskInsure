...
public class RiskQuoteRepository : IRiskQuoteRepository
{
    private readonly Container _container;
    private readonly ILogger<RiskQuoteRepository> _logger;

    public RiskQuoteRepository(Container container, ILogger<RiskQuoteRepository> logger)
    {
