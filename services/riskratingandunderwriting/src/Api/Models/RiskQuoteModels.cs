namespace RiskInsure.RiskRatingAndUnderwriting.Api.Models;

using System.ComponentModel.DataAnnotations;

public class StartRiskQuoteRequest
{
    [Required]
...
public class StartRiskQuoteResponse
{
...
public class SubmitRiskUnderwritingRequest
{
...
public class SubmitRiskUnderwritingResponse
{
    public string QuoteId { get; set; } = string.Empty;
    public string Status { get; set; } = string.Empty;
...
public class AcceptRiskQuoteResponse
{
    public string QuoteId { get; set; } = string.Empty;
    public string Status { get; set; } = string.Empty;
...
public class RiskQuoteResponse
{
    public string QuoteId { get; set; } = string.Empty;
    public string CustomerId { get; set; } = string.Empty;
    public string Status { get; set; } = string.Empty;
