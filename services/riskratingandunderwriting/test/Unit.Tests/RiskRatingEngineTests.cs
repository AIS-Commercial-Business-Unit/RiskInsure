namespace RiskInsure.RiskRatingAndUnderwriting.Tests.Unit;

using FluentAssertions;
using RiskInsure.RiskRatingAndUnderwriting.Domain.Models;
using RiskInsure.RiskRatingAndUnderwriting.Domain.Services;
using Xunit;

public class RiskRatingEngineTests
{
    private readonly RiskRatingEngine _engine = new();
