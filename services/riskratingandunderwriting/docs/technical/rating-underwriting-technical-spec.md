...
|-------------|----------|-------------|
| POST | `/api/risk-quotes/start` | Initiate new insurance quote |
| POST | `/api/risk-quotes/{quoteId}/submit-underwriting` | Submit underwriting information for risk evaluation |
| POST | `/api/risk-quotes/{quoteId}/calculate` | Calculate premium (auto-called after underwriting approval) |
| POST | `/api/risk-quotes/{quoteId}/accept` | Customer accepts quote and coverage terms |
| GET | `/api/risk-quotes/{quoteId}` | Retrieve quote details |
| GET | `/api/customers/{customerId}/risk-quotes` | Retrieve all quotes for a customer |
...
**Cosmos DB Container**: `riskratingandunderwriting`  
**Partition Key**: `/quoteId`
...
**Events Published**: `RiskQuoteStarted`
...
- `QuoteApproved` or `RiskQuoteDeclined`
- `RiskQuoteCalculated` (if approved)
...
### POST /api/risk-quotes/{quoteId}/calculate
...
**Events Published**: `RiskQuoteCalculated`
...
**Interface**: `IRiskRatingEngine`

```csharp
public interface IRiskRatingEngine
{
...
### RiskUnderwritingEngine

**Interface**: `IRiskUnderwritingEngine`

```csharp
public interface IRiskUnderwritingEngine
{
...
**Interface**: `IRiskQuoteManager`

```csharp
public interface IRiskQuoteManager
{
...
**Contract Location**: `services/riskratingandunderwriting/src/Domain/Contracts/Events/RiskQuoteStarted.cs`
