...
**Input**: Feature specification from `/services/nsb.sales/specs/001-sales-ordering/spec.md`
...
```text
services/nsb.sales/specs/001-sales-ordering/
...
**Service Root**: `services/nsb.sales/`
