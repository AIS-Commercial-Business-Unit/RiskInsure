namespace RiskInsure.PolicyLifeCycleMgt.Domain.Models;
...
public class LifeCycle
{
    ...
    public string DocumentType { get; set; } = "LifeCycle";
    
    // Policy Identity
    [JsonPropertyName("policyNumber")]
    public required string PolicyNumber { get; set; }  // LCM-2026-000001
