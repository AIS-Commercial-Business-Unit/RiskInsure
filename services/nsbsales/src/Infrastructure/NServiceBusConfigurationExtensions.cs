namespace RiskInsure.NsbSales.Infrastructure;
...
public static class NServiceBusConfigurationExtensions
{
        ...
        EndpointConfiguration endpointConfiguration)
    {
        ...
        if (!string.IsNullOrWhiteSpace(cosmosEndpoint))
        {
            ...
            persistence.DatabaseName("NsbSalesDb");
            persistence.DefaultContainer("NsbSales-Sagas", "/id");
        }
        ...
        IConfiguration configuration)
    {
        ...
        // Note: endpointConfiguration.AuditSagaStateChanges("audit") requires NServiceBus.SagaAudit package
