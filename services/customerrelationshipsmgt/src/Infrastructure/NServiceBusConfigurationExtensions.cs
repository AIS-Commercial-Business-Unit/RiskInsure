...
namespace RiskInsure.CustomerRelationshipsMgt.Infrastructure;
...
public static class NServiceBusConfigurationExtensions
{
    ...
    EndpointConfiguration endpointConfiguration, IConfiguration configuration, bool isSendOnly)
    {
        ...
        {
            // Todo: Configuration item
            persistence.DefaultContainer("customerrelationshipsmgt-sagas", "/customerId");
            CosmosDbInitializer.EnsureDbAndContainerAsync(cosmosClient, "RiskInsure", "customerrelationshipsmgt-sagas", "/customerId")
