...
public static class NServiceBusConfigurationExtensions
{
    ...
    EndpointConfiguration endpointConfiguration, IConfiguration configuration, bool isSendOnly)
    {
        ...
        {
            // Todo: Configuration item
            persistence.DefaultContainer("fundstransfermgt-sagas", "/transactionId");
            CosmosDbInitializer.EnsureDbAndContainerAsync(cosmosClient, "RiskInsure", "fundstransfermgt-sagas", "/transactionId")
