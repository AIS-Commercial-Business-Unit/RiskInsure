...
**Merge**: main → 001-file-retrieval-config (completed)  
...
### ✅ FIXED 1: Missing ETag on FileRetrievalExecution
...
2. ✅ Updated `FileRetrievalExecutionRepository.UpdateAsync` to use ETag validation (line 226)
...
- **US1**: Configure Basic File Retrieval ✅ (CRUD API, token replacement)
...
1. ✅ Add ETag property to FileRetrievalExecution entity
2. ✅ Implement ETag validation in FileRetrievalExecutionRepository.UpdateAsync
3. ✅ Add idempotency check to CreateConfigurationHandler
4. ✅ Verify ETag flows through soft delete operation

### FUTURE ENHANCEMENTS (Optional)
5. ⚠️ Configure 90-day TTL on FileRetrievalExecution documents in Cosmos DB
...
### Next Steps
1. ✅ Commit fixes to branch 001-file-retrieval-config
