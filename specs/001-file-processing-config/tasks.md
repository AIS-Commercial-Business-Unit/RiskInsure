# Tasks: Client File Processing Configuration

**Input**: Design documents from `/specs/001-file-processing-config/`
...
- `services/file-processing/` as the root directory for this bounded context
...
- [X] T001 Create solution file services/file-processing/FileProcessing.sln with all projects
- [X] T002 Create FileProcessing.Domain project in services/file-processing/FileProcessing.Domain/
- [X] T003 [P] Create FileProcessing.Application project in services/file-processing/FileProcessing.Application/
- [X] T004 [P] Create FileProcessing.Infrastructure project in services/file-processing/FileProcessing.Infrastructure/
- [X] T005 [P] Create FileProcessing.API project in services/file-processing/FileProcessing.API/
- [X] T006 [P] Create FileProcessing.Worker project in services/file-processing/FileProcessing.Worker/
- [X] T007 [P] Create FileProcessing.Contracts project in services/file-processing/FileProcessing.Contracts/
- [X] T008 Create test projects: tests/FileProcessing.Domain.Tests/, tests/FileProcessing.Application.Tests/, tests/FileProcessing.Integration.Tests/
...
- [X] T015 Create .editorconfig with C# 13 coding standards in services/file-processing/.editorconfig
...
- [X] T017 Create README.md in services/file-processing/README.md with project overview and links to specs
...
- [X] T018 Create ProtocolType enum in services/file-processing/FileProcessing.Domain/Enums/ProtocolType.cs
- [X] T019 [P] Create ExecutionStatus enum in services/file-processing/FileProcessing.Domain/Enums/ExecutionStatus.cs
- [X] T020 [P] Create DiscoveryStatus enum in services/file-processing/FileProcessing.Domain/Enums/DiscoveryStatus.cs
- [X] T021 [P] Create AuthType enum in services/file-processing/FileProcessing.Domain/Enums/AuthType.cs
- [X] T022 [P] Create AzureAuthType enum in services/file-processing/FileProcessing.Domain/Enums/AzureAuthType.cs
- [X] T023 Create base ProtocolSettings abstract class in services/file-processing/FileProcessing.Domain/ValueObjects/ProtocolSettings.cs
- [X] T024 [P] Create FtpProtocolSettings value object in services/file-processing/FileProcessing.Domain/ValueObjects/FtpProtocolSettings.cs
- [X] T025 [P] Create HttpsProtocolSettings value object in services/file-processing/FileProcessing.Domain/ValueObjects/HttpsProtocolSettings.cs
- [X] T026 [P] Create AzureBlobProtocolSettings value object in services/file-processing/FileProcessing.Domain/ValueObjects/AzureBlobProtocolSettings.cs
- [X] T027 Create ScheduleDefinition value object in services/file-processing/FileProcessing.Domain/ValueObjects/ScheduleDefinition.cs
- [X] T028 [P] Create EventDefinition value object in services/file-processing/FileProcessing.Domain/ValueObjects/EventDefinition.cs
- [X] T029 [P] Create CommandDefinition value object in services/file-processing/FileProcessing.Domain/ValueObjects/CommandDefinition.cs
- [X] T030 Create FilePattern value object in services/file-processing/FileProcessing.Domain/ValueObjects/FilePattern.cs

### Repository Interfaces (Domain)

- [X] T031 Create IFileProcessingConfigurationRepository interface in services/file-processing/FileProcessing.Domain/Repositories/IFileProcessingConfigurationRepository.cs
- [X] T032 [P] Create IFileProcessingExecutionRepository interface in services/file-processing/FileProcessing.Domain/Repositories/IFileProcessingExecutionRepository.cs
- [X] T033 [P] Create IDiscoveredFileRepository interface in services/file-processing/FileProcessing.Domain/Repositories/IDiscoveredFileRepository.cs

### Infrastructure Foundation

- [X] T034 Create CosmosDbContext in services/file-processing/FileProcessing.Infrastructure/Cosmos/CosmosDbContext.cs with container initialization logic
- [X] T035 Create database setup script in services/file-processing/scripts/DatabaseSetup/ to create Cosmos DB containers with partition keys and unique constraints
- [X] T036 Implement FileProcessingConfigurationRepository in services/file-processing/FileProcessing.Infrastructure/Repositories/FileProcessingConfigurationRepository.cs
- [X] T037 [P] Implement FileProcessingExecutionRepository in services/file-processing/FileProcessing.Infrastructure/Repositories/FileProcessingExecutionRepository.cs
- [X] T038 [P] Implement DiscoveredFileRepository in services/file-processing/FileProcessing.Infrastructure/Repositories/DiscoveredFileRepository.cs
- [X] T039 Create Azure Key Vault client wrapper in services/file-processing/FileProcessing.Infrastructure/KeyVault/KeyVaultSecretClient.cs
- [X] T040 Configure dependency injection for repositories and Key Vault in services/file-processing/FileProcessing.Infrastructure/DependencyInjection.cs

### Application Foundation

- [X] T041 Create TokenReplacementService in services/file-processing/FileProcessing.Application/Services/TokenReplacementService.cs
- [X] T042 Create IProtocolAdapter interface in services/file-processing/FileProcessing.Application/Protocols/IProtocolAdapter.cs
- [X] T043 Create ProtocolAdapterFactory in services/file-processing/FileProcessing.Application/Protocols/ProtocolAdapterFactory.cs
- [X] T044 Create DiscoveredFileInfo record in services/file-processing/FileProcessing.Application/Protocols/DiscoveredFileInfo.cs
...
- [X] T056 Create supporting DTOs (ScheduleDefinitionDto, EventDefinitionDto, CommandDefinitionDto) in services/file-processing/FileProcessing.Contracts/DTOs/

### NServiceBus Configuration

- [X] T057 Configure NServiceBus endpoint for Worker in services/file-processing/FileProcessing.Worker/Program.cs
- [X] T058 Configure NServiceBus endpoint for API in services/file-processing/FileProcessing.API/Program.cs
...
## Phase 3: User Story 1 - Configure Basic File Processing (Priority: P1) 🎯 MVP

**Goal**: Enable system administrators to create FileProcessingConfigurations with HTTPS protocol, date tokens, and schedules. Configurations are persisted and can be retrieved.

**Independent Test**: Create a FileProcessingConfiguration through the API with HTTPS protocol, date tokens (`{yyyy}/{mm}/{dd}`), and daily schedule, then verify the configuration is persisted and can be retrieved. Tokens should be correctly replaced with current date values when evaluated.

### Implementation for User Story 1

- [X] T060 [P] [US1] Create FileProcessingConfiguration entity in services/file-processing/FileProcessing.Domain/Entities/FileProcessingConfiguration.cs
- [X] T061 [P] [US1] Create FileProcessingExecution entity in services/file-processing/FileProcessing.Domain/Entities/FileProcessingExecution.cs
- [X] T062 [P] [US1] Create DiscoveredFile entity in services/file-processing/FileProcessing.Domain/Entities/DiscoveredFile.cs
- [X] T063 [US1] Implement ConfigurationService in services/file-processing/FileProcessing.Application/Services/ConfigurationService.cs with CreateAsync, GetByIdAsync, GetByClientAsync methods
- [X] T064 [US1] Implement CreateConfigurationHandler in services/file-processing/FileProcessing.Application/MessageHandlers/CreateConfigurationHandler.cs
- [X] T065 [US1] Implement ConfigurationController in services/file-processing/FileProcessing.API/Controllers/ConfigurationController.cs with POST and GET endpoints
- [X] T066 [US1] Create CreateConfigurationRequest DTO in services/file-processing/FileProcessing.API/Models/CreateConfigurationRequest.cs
- [X] T067 [US1] Create ConfigurationResponse DTO in services/file-processing/FileProcessing.API/Models/ConfigurationResponse.cs
- [X] T068 [US1] Implement ConfigurationRequestValidator using FluentValidation in services/file-processing/FileProcessing.API/Validators/ConfigurationRequestValidator.cs
- [X] T069 [US1] Add token replacement validation logic to TokenReplacementService (validate tokens not in server name)
- [X] T070 [US1] Add JWT authentication and claims-based authorization to API in services/file-processing/FileProcessing.API/Program.cs
...
- [X] T073 [US1] Configure OpenAPI/Swagger documentation in services/file-processing/FileProcessing.API/Program.cs
...
**Independent Test**: Create a FileProcessingConfiguration with a schedule, place a matching file at the configured location, advance/wait for scheduled time, and verify the system detects the file and creates a FileProcessingExecution record.
...
- [X] T095 [US3] Create integration test helpers for verifying message publishing in tests/FileProcessing.Integration.Tests/MessageTestHelpers.cs
...
**Goal**: Support clients with multiple data feeds from different sources. Each FileProcessingConfiguration operates independently with different protocols, schedules, and file patterns. System handles multiple configurations per client without interference.

**Independent Test**: Create 3 FileProcessingConfigurations for one client with different protocols (FTP, HTTPS, Azure Blob) and schedules, simulate scheduled checks for each, and verify each configuration executes independently with correct protocol handling and no cross-configuration interference.
...
**Goal**: Enable administrators to update existing FileProcessingConfigurations (change protocol, schedule, file patterns) and delete configurations when no longer needed. Changes are persisted with optimistic concurrency control (ETag). Execution history is retained after deletion.
...
- [X] T107 [US5] Implement UpdateConfigurationHandler in services/file-processing/FileProcessing.Application/MessageHandlers/UpdateConfigurationHandler.cs
- [X] T108 [US5] Implement DeleteAsync method in ConfigurationService (soft delete by setting IsActive = false)
- [X] T109 [US5] Implement DeleteConfigurationHandler in services/file-processing/FileProcessing.Application/MessageHandlers/DeleteConfigurationHandler.cs
...
- [X] T112 [US5] Create UpdateConfigurationRequest DTO in services/file-processing/FileProcessing.API/Models/UpdateConfigurationRequest.cs
...
- [X] T119 [US6] Create ExecutionHistoryController in services/file-processing/FileProcessing.API/Controllers/ExecutionHistoryController.cs
...
- [X] T122 [US6] Create ExecutionHistoryResponse DTO in services/file-processing/FileProcessing.API/Models/ExecutionHistoryResponse.cs
...
- [X] T133 [P] Create file-processing-standards.md documentation in services/file-processing/docs/file-processing-standards.md with domain terminology glossary
- [X] T134 [P] Create deployment guide in services/file-processing/docs/deployment.md for Azure Container Apps
...
Task T036: "Implement FileProcessingConfigurationRepository"
Task T037: "Implement FileProcessingExecutionRepository"
