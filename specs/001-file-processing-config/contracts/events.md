# Event Contracts: Client File Processing Configuration
...
**Purpose**: Notifies that a new FileProcessingConfiguration has been created.
...
**Purpose**: Notifies that a FileProcessingConfiguration has been updated.
...
**Purpose**: Notifies that a FileProcessingConfiguration has been deleted (soft-deleted).
...
endpointConfiguration.Conventions()
    .DefiningEventsAs(type => type.Namespace?.StartsWith("FileProcessing.Contracts.Events") == true);
